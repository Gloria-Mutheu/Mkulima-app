        ...
        <form action="{{ route('sup-fertilizer.store') }}" method="POST" enctype="multipart/form-data"
            ...
            <div class="flex flex-col space-y-4 relative w-full">
                ...
                <div class="flex flex-col py-2">
                    ...
                    <input type="number" min="1" placeholder="Enter Price" name="price" required :value="old('price')"
                        class=" border border-gray-300 px-3 py-2 rounded">
                ...
                <button type="submit"
                    class="bg-blue-500 hover:bg-blue-950 text-white px-12 py-2 rounded mx-auto">Add</button>
            </div>
        </form>
    </div>
