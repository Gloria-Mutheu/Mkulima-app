<x-app-layout>
    <div class="flex justify-center my-5 flex-col">
            ...
            <table class="table-auto border-collapse border border-green-800">
                <thead>
                    <tr>
                        ...
                        <th class="border border-green-600 px-4 py-2">Review</th>
        ...
        ">
                        ...
                        <td class="border border-green-600 px-4 py-2">
                            <a href="{{ route('client.review-fertilizer.create', $order->id) }}"
                                class="bg-blue-500 text-white p-2 rounded-lg mx-2">
                                Click to Review
                            </a>
                        </td>
                        @endif
